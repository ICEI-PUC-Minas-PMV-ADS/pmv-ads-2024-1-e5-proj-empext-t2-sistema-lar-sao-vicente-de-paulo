...
export class CreateModeloRelatorioPiaOpcaoController {
    constructor(private createModeloRelatorioPiaOpcao: CreateModeloRelatorioPiaOpcaoService) {}
    ...
    @ApiResponseError()
    async handle(@Body() data: CreateModeloRelatorioPiaOpcaoDto): Promise<ModeloRelatorioPiaRespostaOpcao> {
        const modeloRelatorioPiaOpcao = await this.createModeloRelatorioPiaOpcao.execute(data);
