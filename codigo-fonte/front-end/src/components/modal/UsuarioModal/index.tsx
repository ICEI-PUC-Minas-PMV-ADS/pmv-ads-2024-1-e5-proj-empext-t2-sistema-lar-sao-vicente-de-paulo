...
export const UsuarioModal = () => {
    ...
    return (
        <>
            <Button type="primary" onClick={showModal} size="large" icon={<UserAddOutlined />} >
                Cadastrar
            </Button>
            <Modal
                destroyOnClose
                        ...
                        <div className="flex flex-col">
                            ...
                            <div className="flex justify-between gap-4">
                                <Form.Item
                                    label="CPF"
                                    name="cpf"
                                    rules={[{ required: true, message: 'Insira o CPF do usuário!' }]}
                                    className="w-full"
                                    required
                                >
                                ...
                                <Form.Item
                                    ...
                                    label="Cargo"
                                    name="cargo"
                                    rules={[{ required: true, message: 'Insira um cargo para o usuário!' }]}
                                    className="w-full"
                                >
